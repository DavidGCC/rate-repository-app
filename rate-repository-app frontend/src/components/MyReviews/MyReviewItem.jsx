...
const MyReviewItem = ({ item, handleDeleteReview, handleViewRepository }) => {
    return (
        <View style={styles.container}>
            ...
            <ReviewButtons handleViewRepository={handleViewRepository} handleDeleteReview={handleDeleteReview} />
        </View>
    );
};
